//
//  TutorialMVWithRepositioning.swift
//  MatchedViewTraining
//
...
struct TutorialMVWithRepositioning: View {
...
struct TutorialMVWithRepositioning_Previews: PreviewProvider {
    static var previews: some View {
        TutorialMVWithRepositioning()
    }
}
